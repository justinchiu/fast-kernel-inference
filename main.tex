...
\icmltitlerunning{Embedded Structured Models}
...
\twocolumn[
\icmltitle{Embedded Structured Prediction}
...
\icmlauthor{Justin T Chiu}{equal,ct}
\icmlauthor{Yuntian Deng}{equal,h}
\icmlauthor{Alexander M Rush}{ct}

\end{icmlauthorlist}

\icmlaffiliation{ct}{Cornell Tech}
\icmlaffiliation{h}{Harvard}


\icmlcorrespondingauthor{Justin T Chiu}{jtc257@cornell.edu}
